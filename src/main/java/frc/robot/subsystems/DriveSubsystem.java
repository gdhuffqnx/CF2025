...
public class DriveSubsystem extends SubsystemBase {
  ...
  SwerveDriveOdometry m_odometry = new SwerveDriveOdometry(
      ...
      Rotation2d.fromDegrees(DriveConstants.m_gyro.getAngle()),
  ...
  public void drive(double xSpeed, double ySpeed, double rot, boolean fieldRelative) {
    ...
    double error = DriveConstants.m_gyro.getAngle()- MAXSwerveModule.desiredAngle(xSpeed, ySpeed);
  ...
  public double getHeading() {
    return Rotation2d.fromDegrees(DriveConstants.m_gyro.getAngle()).getDegrees();
  }
  ...
  public double getTurnRate() {
    return DriveConstants.m_gyro.getRate() * (DriveConstants.kGyroReversed ? -1.0 : 1.0);
  }
}
